...
def generate_pdf(barrio)
    ...
    send_data(
      pdf,
      filename: "barrio_#{barriot.type_document}_#{barrio.admin_user.email}.pdf",
...
# tabla de index
 index title: "Barrios" do
   ...
   actions  do |client|
     ...
     link_to 'Create PDF document',admin_barrio_path(client, format: :pdf)
