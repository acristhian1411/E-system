...
#
 permit_params :nombre, :apellido, :n_cedula, :cli_telefono, :limite_credito, :activo, :ciudades_id, :barrio_id
#
# or
#
# permit_params do
...
#formulario personalizado
     ...
     form do |f|
      f.inputs "Articulos" do
       ...
       f.input :ciudades_id,  label: "Ciudad", :as => :select, :collection => Ciudade.all.map{|a|["#{a.descripcion}", a.id]}
