...
permit_params :cliente_id, :admin_user_id, :sucursal_id, :num_factura, :fecha, venta_detalle_attributes:[:id, :producto_id, :monto_desc, :porcent_desc, :cantidad, :precio_venta]
